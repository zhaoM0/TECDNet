...
def get_option():
    ...
    # model name
    parser.add_argument("--arch", type=str, required=True, default="RBF_TECDNet_S", help="model name")
    
    # dir setting 
    parser.add_argument("--pth_dir", type=str, default="./experiments/TECDNet-S", help="weights dir")
    ...
    parser.add_argument("--resume_tg", type=str, default="last", help="resmue tag")
